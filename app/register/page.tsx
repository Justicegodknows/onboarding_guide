        ...
        <div className="min-h-screen flex items-center justify-center bg-white px-4">
            <div className="relative w-full max-w-md">
                <div className="mb-8 text-center">
                    ...
                    <p className="text-sm text-gray-500 mt-2">Register a secure VaultMind user account.</p>
                </div>

                <div className="rounded-3xl border border-gray-200 bg-white shadow-md px-8 py-9">
                    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
                        <div className="flex flex-col gap-1.5">
                            <label htmlFor="vm-email" className="text-xs font-bold uppercase tracking-widest text-gray-500">
                                Email or username
                            </label>
                            <input
                                id="vm-email"
                        ...
                        <div className="flex flex-col gap-1.5">
                            <label htmlFor="vm-display-name" className="text-xs font-bold uppercase tracking-widest text-gray-500">
                                Display name
                            </label>
                            <input
                                id="vm-display-name"
                        ...
                        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            <div className="flex flex-col gap-1.5">
                                <label htmlFor="vm-password" className="text-xs font-bold uppercase tracking-widest text-gray-500">
                                    Password
                                </label>
                                <input
                                    id="vm-password"
                            ...
                            <div className="flex flex-col gap-1.5">
                                <label htmlFor="vm-confirm-password" className="text-xs font-bold uppercase tracking-widest text-gray-500">
                                    Confirm password
                                </label>
                                <input
                        ...
                        <div className="flex flex-col gap-1.5">
                            <label htmlFor="vm-dept" className="text-xs font-bold uppercase tracking-widest text-gray-500">
                                Department
                            </label>
                            <input
                                id="vm-dept"
