...
class Settings(BaseSettings):
    ...
    # Local EUZ Project docs folder (primary knowledge base for RAG)
    # Relative path resolved from rag_backend/; override with an absolute path if needed.
    EUZ_DOCS_FOLDER: str = "docs/EUZ Project"
